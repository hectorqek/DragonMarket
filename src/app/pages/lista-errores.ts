...
export class ManejadorErroresPageModule {
    private static Mensajes= {
        ...
        'V0009' : 'Sobregiro NO Autorizado',
        'V0010' : 'Valor Sobregiro es Cero.',
        'V0011' : 'Valor Sobregiro Insuficiente.'
    };
    private static Detalle = {
        ...
        'V0010' : 'Tiene activo el beneficio de Sobregiro, pero su valor es 0.',
        'V0011' : 'Tiene activo el beneficio de Sobregiro, pero su valor no es suficiente para la compra.'
    };
    ...
    public static getErrors (lista: any[], titulo ) {
        console.log('lista:ppppppppppppp ', lista);
